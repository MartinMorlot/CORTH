...
i= 1
# pdf("Plots_verifications/Tes_selection_check_comprehensive_grass_new.pdf")
...
data_anomaly_post <- dataFrame_anomaly_data[which(format(dataFrame_anomaly_data$date, "%Y") >= 2020),]
