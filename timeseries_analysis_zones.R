...
pdf(paste0("Plots_correlations/Comparison_range_normal_over_",stringr::str_replace(thresh,"[.]", ""),".pdf"))
object_count <- 1
...
writeVector(good_cor_lines, paste0("Shp_files/Results/good_correlation_normal_all_grass_",stringr::str_replace(thresh,"[.]", ""),".gpkg"), overwrite=T)
